<template>
  <div>
    ...
    <el-table :data="articleList" border highlight-current-row v-loading="articleTableLoading">
      ...
      <el-table-column prop="author" label="作者" width="120px" :filters="authorList" :filter-method="filter" filter-placement="bottom"></el-table-column>
      <el-table-column prop="createDate" label="创建时间" sortable width="180px"></el-table-column>
      <el-table-column prop="title" label="标题"></el-table-column>
      <el-table-column prop="type" label="类型" width="120px" :filters="articleTypeList" :filter-method="filter" filter-placement="bottom"></el-table-column>
    ...
    <el-pagination class="pagination" :total="articleAmount" :current-page="queryCondition.currentPageNum" :page-sizes="[10, 20, 30, 40, 50, 100]" :page-size="queryCondition.pageSize" layout="total, sizes, prev, pager, next, jumper" background @size-change="handleSizeChange" @current-change="handleCurrentChange"></el-pagination>
  </div>
